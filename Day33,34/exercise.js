// 1. Select the <h1> element by "drilling into DOM" and save it in a variable with a name of your choice
...
h1Element = document.getElementById("head");
console.dir(h1Element);

// 4. Select the second <p> element with querySelector (you might need to add something in the HTML ConvolverNode, e,g. a class)
//       and store it in new variable with a name of your choice
...
paragraph2.textContent = "this was changes by Venky";
